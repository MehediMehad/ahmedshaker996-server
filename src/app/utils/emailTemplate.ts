                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                                ...
                                                <tr>
                                                    <td valign="top" align="center" class="es-m-p0r"
                                                        style="padding:0;Margin:0;width:560px, background: #2CB543">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://everbrighthomecare.co.uk/wp-content/uploads/2023/08/20240426_124633_0000-e1714395307274.png"
                                                                        alt="Logo" width="400" height="100" title="Logo"
                                                                        style="display:block;font-size:120px;border:0;outline:none;text-decoration:none; height: 200px; width: 350px">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://erowefr.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png"
                                                                        alt="" width="100"
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <h1 class="es-m-txt-c"
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:36px;font-style:normal;font-weight:bold;line-height:46px;color:#333333">
                                                                        A term has been uploaded </h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#2CB543;background:#5c68e2;border-width:0px;display:inline-block;border-radius:6px;width:auto;border-top:2px undefined #5c68e2;border-right:2px undefined #5c68e2;border-bottom:2px undefined #5c68e2;border-left:2px undefined #5c68e2"><a
                                                                            href="${link}" target="_blank"
                                                                            class="es-button"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#f37600;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2;border-left-width:30px;border-right-width:30px">download
                                                                            new term pdf</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Got a question?&nbsp;Email us at&nbsp;<a
                                                                            target="_blank"
                                                                            href="mailto:support@everbriteHomecare.com"
                                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">support@</a><a
                                                                            target="_blank"
                                                                            href="mailto:support@everbriteHomecare.com"
                                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">everbriteHomecare</a><a
                                                                            target="_blank"
                                                                            href="mailto:support@everbriteHomecare.com"
                                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">.com</a>&nbsp;or
                                                                        give us a call at&nbsp;<a target="_blank" href="tel: +000
                                                                            123 456"
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="www.x.com/" target="_blank">
                                                                                    <img title="X"
                                                                                        src="https://erowefr.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png"
                                                                                        alt="X" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </a>
